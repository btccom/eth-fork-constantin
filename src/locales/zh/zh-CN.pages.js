...
const pageMesage = {
  pages: {
    appName: '以太坊区块链浏览器',
    upgradedTip: '君士坦丁堡/圣彼得堡升级',
    block: '区块',
    sinceLastBlock: '自最新区块',
    blockstoGo: '区块倒计',
    activeAt: '君士坦丁堡/圣彼得堡将在 {block} 区块激活，预计时间约为 {time}。',
    forkRemark:
      '君士坦丁堡/圣彼得堡分叉升级主要变动为延迟难度炸弹、以太币减产。',
    viewMore: '点此查看更多',
    height: '高度',
    age: '块龄',
    miner: '播报方',
    ...
    introduction: '君士坦丁堡/圣彼得堡介绍',
    introPrg1Title: '1.君士坦丁堡/圣彼得堡硬分叉是什么？',
    introPrg1:
      '君士坦丁堡/圣彼得堡硬分叉将在区块7280000激活，预计在2019年2月28日左右。君士坦丁堡/圣彼得堡硬分叉是大都会的第二阶段，主要调整以太坊的经济政策，主要包括延迟难度炸弹，以太币减产以及燃料Gas成本的大幅降低。',
    introPrg2Title: '2.本次硬分叉会实现哪些EIP改进方案？',
    introPrg2: '君士坦丁堡/圣彼得堡硬分叉包括5项以太坊改进方案',
    introPrg2eip145:
    ...
    introPrg3Item3Sub2: '（2）君士坦丁堡/圣彼得堡（2019年2月）',
    introPrg3Item4: '4.宁静（时间待定）：采用POS共识即Casper共识算法',
    perHour: '小时线',
    perDay: '日线',
    chartForkRemarkText: '君士坦丁堡/圣彼得堡分叉',
    reset: '重置',
    zoom: '缩放',
    ...
    forkedAt:
      '君士坦丁堡/圣彼得堡硬分叉已成功激活于区块 {block}，激活时间为 {time}',
    postponedTip: '延迟',
    seeDetail: '查看详情',
    tbd: '待定',
    postponedTip: '由于发现安全漏洞，君士坦丁堡/圣彼得堡升级推迟，升级时间待定',
    remove1283Tip: '* 圣彼得堡升级将移除 EIP 1283。',
    linkText: '超<b>50万</b>矿工选择BTC.com，来了就不想走的高收益矿池！'
  }
};
